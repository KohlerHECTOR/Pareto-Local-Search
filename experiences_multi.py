...
import time
import numpy as np
from utils_multiobj import read_instance, init_population, voisinage, init_population_S_weighted, voisinage_L, ideal_nadir
from pls_multiobj import PLS, PLS2, PLS4
...
class experience():
    ...
    def __init__(self, nb_crit, instance_size, iter_max_, nb_inst):
        ...
        for i in range(nb_inst):
            ...
            initial_pop_S = init_population_S_weighted(nb_crit, instance["objects"], instance["max_weight"], S = 5)
            pls1_list.append(PLS(nb_crit, voisinage, initial_pop, instance, iter_max = iter_max_))
            pls2_list.append(PLS2(nb_crit, voisinage, initial_pop, instance, iter_max = iter_max_))
            pls3_list.append(PLS2(nb_crit, voisinage, initial_pop_S, instance, iter_max = iter_max_))
            pls4_list.append(PLS4(nb_crit, voisinage_L, initial_pop_S, instance, iter_max = iter_max_))
